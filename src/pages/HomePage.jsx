...
const HeroSection = ({ onOpenAuth }) => {
  ...
  return (
    <section id="hero" style={{ backgroundColor: COLORS.bg, minHeight: '100vh' }} className="relative flex items-center">
...
const ServiciosSection = () => {
  ...
  return (
    <section id="servicios" style={{ backgroundColor: COLORS.bg }}>
...
const StatsSection = () => {
  ...
  return (
    <section id="stats" style={{ backgroundColor: COLORS.cardBg }}>
...
const CTASection = ({ onOpenAuth }) => {
  ...
  return (
    <section id="contacto" style={{ backgroundColor: COLORS.bg }}>
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 py-24 md:py-32">
        <motion.div
          {...fadeIn(reduced)}

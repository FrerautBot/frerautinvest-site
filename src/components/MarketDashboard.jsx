...
const SEC=[{sector:'Tecnologia',pct:32,color:'#3b82f6'},{sector:'Finanzas',pct:18,color:'#10b981'},{sector:'Salud',pct:14,color:'#8b5cf6'},{sector:'Energia',pct:12,color:'#f59e0b'},{sector:'Consumo',pct:10,color:'#ec4899'},{sector:'Industrial',pct:8,color:'#84cc16'},{sector:'Cash',pct:6,color:'#6b7280'}];
